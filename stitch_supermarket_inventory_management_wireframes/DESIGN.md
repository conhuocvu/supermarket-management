...
The color architecture is built on a "Natural Professionalism" theme. The **primary (#00503e)** is used for key actions and brand presence, evoking freshness and reliability. 

- **Primary & Tints:** Use primary for core interaction points. The primary-fixed (#acf1d7) serves as a soft background for selected states or categories (e.g., "In Stock" badges).
- **Surface Strategy:** The background uses a slightly off-white gray-blue (#f8f9ff) to reduce screen glare during long shifts, while the Surface remains pure white to create a distinct layer of information.
- **Accents:** The secondary-container (#fca867) is reserved strictly for warnings, low-stock alerts, or items requiring immediate managerial attention.
...
### Buttons
- **Primary:** primary (#00503e) background, white text, 16px radius. No shadow; high color contrast provides the hierarchy.
- **Secondary:** primary tint background (10% opacity) with primary text. Used for less critical actions.
...
- **Selection State:** Active list items should use a 2px left-side border in primary and a light primary-fixed (#acf1d7) background tint.

### Inputs
- **Search & Fields:** Light gray fill (#F3F4F6) with no border in resting state. On focus, transition to a white background with a 2px primary border.
- **Icons:** Use 24px line-icons with a consistent stroke weight (1.5px to 2px) to match the Inter typography weight.

### Feedback & Status
- **Low Stock Chip:** secondary-container (#fca867) background with dark text.
- **Success Toast:** primary background with white text, positioned at the top of the screen to avoid thumb obstruction.